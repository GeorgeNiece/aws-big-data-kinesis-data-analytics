package com.mycompany.kda.kinesisanalytics;
...
public class BasicStreamingJob {
    ...
    private static final String inputStreamName = "experiment-input-stream";
    private static final String outputStreamName = "experiement-output-stream";
